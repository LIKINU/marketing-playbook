...
def report(res, verbose=True):
    ...
    print("=" * 72)
    print(f"  扫描范围：{res['total']} 个文件（已排除 .git／.workbuddy／优化记录／解析产物／__pycache__）")
